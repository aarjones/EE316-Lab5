...
## RGB LEDs
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports full_pwm]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports full_pwm]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports full_pwm]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports full_pwm]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports full_pwm]
...
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {btns_3bits_tri_i[0]}]
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {btns_3bits_tri_i[1]}]
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports {btns_3bits_tri_i[2]}]
...
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports {lcd_6bits_tri_o[0]}]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports {lcd_6bits_tri_o[1]}]
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {lcd_6bits_tri_o[2]}]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {lcd_6bits_tri_o[3]}]
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports servo_pwm]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports full_pwm]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports buzzer_pwm]
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports {lcd_6bits_tri_o[4]}]
set_property -dict {PACKAGE_PIN N18 IOSTANDARD LVCMOS33} [get_ports {lcd_6bits_tri_o[5]}]
